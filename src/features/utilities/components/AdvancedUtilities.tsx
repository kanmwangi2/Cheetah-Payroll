...
import { backupCollectionToCloud } from '../../../shared/services/backup.service';
import { restoreCollectionFromCloud } from '../../../shared/services/restore.service';
  ...
  return (
    <div className="advanced-utilities">
      ...
      <div style={{ marginBottom: 8 }}>
        ...
        <button onClick={handleBackup} disabled={!companyId || loading}>
          Backup to Cloud
        </button>
      </div>
      <div style={{ marginBottom: 8 }}>
        ...
        />
        <button onClick={handleRestore} disabled={!companyId || !restorePath || loading}>
          Restore from Cloud
        </button>
      </div>
