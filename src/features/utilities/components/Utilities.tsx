...
const faq = [
  { q: 'How do I add a new staff member?', a: 'Go to Staff section and use the Add Staff form.' },
  {
    ...
    a: 'Use the Import/Export buttons in each section (Staff, Payments, Deductions).',
  },
  {
    q: 'How is payroll calculated?',
    a: 'Payroll uses Rwanda tax law and the calculation sequence described in Blueprint.md.',
  },
  ...
  <div className="utilities-module">
    ...
    <div className="utilities-sections">
      ...
      <section className="utilities-docs">
        ...
        <p>
          See{' '}
          <a href="./Blueprint.md" target="_blank" rel="noopener noreferrer">
            Blueprint.md
          </a>{' '}
          for full product documentation and technical details.
        </p>
      </section>
      <section className="utilities-support">
        <h3>Support</h3>
        <p>
          Email: support@cheetahpayroll.com
          <br />
