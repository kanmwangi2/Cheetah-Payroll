  ...
  return (
    <div className="reports-module">
      ...
      <div className="reports-actions">
        <button onClick={handleShowKPIs} disabled={loading} className="primary-btn">
          Show KPIs
        </button>
        <button onClick={() => handleExport('payrolls')} disabled={loading}>
          Export Payrolls
        </button>
        <button onClick={() => handleExport('staff')} disabled={loading}>
          Export Staff
        </button>
        <button onClick={() => handleExport('payments')} disabled={loading}>
          Export Payments
        </button>
        <button onClick={() => handleExport('deductions')} disabled={loading}>
          Export Deductions
        </button>
