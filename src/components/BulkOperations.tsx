...
import { bulkUpdateStaff, bulkDeleteStaff, bulkUpdatePayrolls, bulkDeletePayrolls } from '../bulkOpsUtils';
    ...
    <div className="bulk-operations">
      ...
      <div style={{ marginBottom: 8 }}>
        ...
        <input
          ...
          style={{ width: 120, marginRight: 8 }}
        />
        <button onClick={handleUpdate} disabled={!ids || !field}>Bulk Update</button>
        <button onClick={handleDelete} disabled={!ids}>Bulk Delete</button>
      </div>
