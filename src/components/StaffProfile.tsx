      ...
      <div className="staff-profile-card">
        ...
        {edit ? (
          <div className="staff-profile-edit">
            ...
            <button className="staff-profile-btn" onClick={handleSave}>Save</button>
          </div>
        ) : (
          <div className="staff-profile-view">
            <div><b>Name:</b> {profile.personalDetails.firstName} {profile.personalDetails.lastName}</div>
            <div><b>ID/Passport:</b> {profile.personalDetails.idNumber}</div>
            <div><b>Department:</b> {profile.employmentDetails.department}</div>
            {/* Add more fields as needed */}
            <button className="staff-profile-btn" onClick={() => setEdit(true)}>Edit</button>
          </div>
        )}
      </div>
    </div>
